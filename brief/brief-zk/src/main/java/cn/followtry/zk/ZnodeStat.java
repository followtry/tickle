...
public class ZnodeStat {
  ...
  public String toString() {
    return "ZnodeStat{" + "czxid=" + czxid + ", mzxid=" + mzxid + ", ctime=" + ctime + ", mtime="
            + mtime + ", version=" + version + ", cversion=" + cversion + ", aversion=" +
            aversion + ", ephemeralOwner=" + ephemeralOwner + ", dataLength=" + dataLength + ", " +
            "numChildren=" + numChildren + ", pzxid=" + pzxid + '}';
  }
}
