...
public class ZkClientFactory {
  ...
  public static CuratorFramework getZkClient() {
    client = CuratorFrameworkFactory.builder().canBeReadOnly(ZkProp
              .canBeReadOnly()).connectionTimeoutMs(ZkProp.connectionTimeoutMs())
              .sessionTimeoutMs(ZkProp.sessionTimeoutMs()).retryPolicy(ZkProp.retryPolicy())
