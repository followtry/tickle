...
//		getAverAgeGroupBySex();
	...
	private static void getAverAgeGroupBySex() {
		...
		System.out.println("================================");
		Map<User.SEX, Double> collect=users.parallelStream().collect(Collectors.groupingBy(User::getSex, Collectors.averagingInt(User::getAge)));
	...
	private static void getAgeSumGroupBySex() {
		...
		System.out.println("====================================");
		//map-reduce方式
		Map<User.SEX, Integer> collect=users.parallelStream().collect(Collectors.groupingBy(User::getSex, Collectors.reducing(0, User::getAge, Integer::sum)));
		System.out.println("新方式：" + collect);
	}
	...
	private static void groupBySexList() {
		...
		System.out.println("原方式：" + map);
		System.out.println("=======================================");
		Map<User.SEX, List<String>> collect=users.parallelStream().collect(Collectors.groupingBy(User::getSex, Collectors.mapping(User::getName, Collectors.toList())));
		System.out.println("新方式：" + collect);
	}
	...
	private static void groupBySex() {
		...
		System.out.println("原方式：" + map);
		System.out.println("=============================================");
		Map<User.SEX, Integer> collect=users.parallelStream().collect(Collectors.groupingBy(User::getSex, Collectors.summingInt(value -> 1)));
		System.out.println("新方式：" + collect);
	}
	...
	private static void getOlderThan(Integer minAge) {
		...
		System.out.println("=========================================");
		List<User> userList=users.parallelStream().filter(user -> user.getAge() > minAge).collect(Collectors.toList());
	...
	private static void getDissHobbies() {
		...
		System.out.println("==========================================");
		Set<String> res=users.stream().flatMap(user -> user.getHobbies().stream()).collect(Collectors.toSet());
	...
	private static void getAllHobby(String key) {
		...
		System.out.println("原方式：" + result);
		System.out.println("========================================================");
		List<User> res=users.stream().filter(user -> user.getHobbies().contains(key)).collect(Collectors.toList());
		System.out.println("新方式：" + res);
	}
	...
	private static void getFirstHobby(String key) {
		...
		System.out.println("======================================");
		Optional<User> first=users.stream().filter(user -> user.getHobbies().contains(key)).findFirst();
	...
	private static List<User> getUserList() {
		List<User> users=new ArrayList<User>() {
			{
				add(new User(1, "jingzz2", 232, Arrays.asList("Letter writing2", "music3", "photography6", "tennis3"), User.SEX.FEMALE));
				add(new User(2, "jingzz1", 231, Arrays.asList("Letter writing1", "music4", "photography5", "tennis4"), User.SEX.MALE));
				add(new User(3, "jingzz3", 233, Arrays.asList("Letter writing3", "music1", "photography8", "tennis1"), User.SEX.MALE));
				add(new User(4, "jingzz4", 234, Arrays.asList("Letter writing4", "music7", "photography2", "tennis7"), User.SEX.FEMALE));
				add(new User(5, "jingzz0", 230, Arrays.asList("Letter writing0", "java", "photography9", "tennis0"), User.SEX.FEMALE));
