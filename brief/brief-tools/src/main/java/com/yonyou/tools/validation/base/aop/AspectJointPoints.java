...
public interface AspectJointPoints {
	...
	/** 业务控制器接口的全部操作方法 **/
	public static final String BUSINESS_RESTCONTROLLER_ACTIONS = "@within(com.yonyou.tools.validation.base.stereotype.XRestController)";

	/** 数据访问服务接口的全部操作方法；**/
	public static final String BUSINESS_DATA_ACCESS_ACTIONS = "@within(com.yonyou.tools.validation.base.stereotype.XRepository)";
	
	/** 组件的全部操作方法；**/
	public static final String BUSINESS_COMPONENT_ACTIONS = "@within(com.yonyou.tools.validation.base.stereotype.XComponent)";
